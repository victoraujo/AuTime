        ...
        GeometryReader{ geometry in
            ...
            .toolbar {
                ...
                ToolbarItem(placement: ToolbarItemPlacement.confirmationAction) {
                    Button(action: {
                        showingPopover = true
                        ActivityViewModel.shared.createActivity(category: "Teste", completions: [Completion(date: Date(), feedback: "Feliz")], star: false, name: "Testando", days: [1,2,3,4,5,6,7], steps: 2, time: Date(), handler: {})
                    }, label: {
